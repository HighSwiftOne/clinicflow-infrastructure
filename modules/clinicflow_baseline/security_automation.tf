...
# ====================================================================
# PILLAR 4: EVENT-DRIVEN SOC NERVOUS SYSTEM
# ====================================================================

# 1. The Central Router (Encrypted SNS Topic)
resource "aws_sns_topic" "security_alerts" {
  name              = "clinicflow-security-alerts"
  kms_master_key_id = "alias/aws/sns" # Enterprise-grade encryption at rest
}

# 2. The Dispatch (Email Subscription)
...
# 3. The Tripwire (EventBridge Sensor for GuardDuty)
resource "aws_cloudwatch_event_rule" "guardduty_findings" {
  name        = "clinicflow-guardduty-findings"
  description = "Captures all GuardDuty security findings in real-time"
...
# 4. The Nerve Connection (Linking the Sensor to the Router)
...
# 5. The IAM Bridge (Allowing EventBridge to fire the SNS Topic)
